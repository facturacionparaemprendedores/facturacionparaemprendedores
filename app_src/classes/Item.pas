...
type
  ...
  {  Id: Integer;
    ...
    Id_Informacion_Aduanera: Integer;
    Id_Emp: Integer;
          }
    Id_Concepto: Integer;
    ClaveProdServ: string;
...
procedure TItem.New(Claveprodserv: string; Noidentificacion: string; Claveunidad: string; Unidad: string;
                  Descripcion: string; Desc_Larga: string; Precio: Currency; Objetoimp: string;
                  Id_Impuesto: Integer; Id_Informacion_Aduanera: Integer);
begin
  Qry.Querry.Close;
...
procedure TItem.Update(Id :Integer; Claveprodserv: string; Noidentificacion: string; Claveunidad: string; Unidad: string;
                  Descripcion: string; Desc_Larga: string; Precio: Currency; Objetoimp: string;
                  Id_Impuesto: Integer; Id_Informacion_Aduanera: Integer);
begin
  Qry.Querry.Close;
...
procedure TItem.Delete(id: Integer);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TItem.GetByID(Id:Integer);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TItem.GetByClave(Clave: string);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TItem.GetByDescripcion(Descripcion: string);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
