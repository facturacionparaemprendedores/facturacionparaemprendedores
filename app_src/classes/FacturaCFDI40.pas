...
procedure TFacturaCFDI40.New(Claveprodserv: string; Noidentificacion: string; Claveunidad: string; Unidad: string;
                  Descripcion: string; Desc_Larga: string; Precio: Currency; Objetoimp: string;
                  Id_Impuesto: Integer; Id_Informacion_Aduanera: Integer);
begin
  Qry.Querry.Close;
...
procedure TFacturaCFDI40.Update(Id :Integer; Claveprodserv: string; Noidentificacion: string; Claveunidad: string; Unidad: string;
                  Descripcion: string; Desc_Larga: string; Precio: Currency; Objetoimp: string;
                  Id_Impuesto: Integer; Id_Informacion_Aduanera: Integer);
begin
  Qry.Querry.Close;
...
procedure TFacturaCFDI40.Delete(id: Integer);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TFacturaCFDI40.GetByID(Id:Integer);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TFacturaCFDI40.GetByClave(Clave: string);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TFacturaCFDI40.GetByDescripcion(Descripcion: string);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
Constructor TFacturaCFDI40.Create;
begin
  Inherited Create;
...
Destructor TFacturaCFDI40.Destroy;
begin
  Inherited Destroy;
   Qry.Free
end;
