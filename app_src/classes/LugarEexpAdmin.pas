...
procedure TLugarExpAdmin.New(Descripcion: string; Uso: string; Tipo_Especial: string; Activo: Boolean);
begin
  Qry.Querry.Close;
...
procedure TLugarExpAdmin.Update(Descripcion: string; Uso: string; Tipo_Especial: string; Activo: Boolean);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TLugarExpAdmin.Delete;
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TLugarExpAdmin.GetAll;
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
...
procedure TLugarExpAdmin.GetByID(Id:Integer);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
  Qry.Querry.SQL.Add('SELECT ID, DESCRIPCION, USO, TIPO_ESPECIAL, ACTIVO, ID_EMP ');
...
procedure TLugarExpAdmin.GetByDescripcion(Descripcion: string);
begin
  Qry.Querry.Close;
  Qry.Querry.SQL.Clear;
  Qry.Querry.SQL.Add('SELECT ID, DESCRIPCION, USO, TIPO_ESPECIAL, ACTIVO, ID_EMP  ');
...
Constructor TLugarExpAdmin.Create;
begin
  Inherited Create;
  Qry := TQry.Create;
  Id := 0;
...
Destructor TLugarExpAdmin.Destroy;
begin
  Inherited Destroy;
  Qry.Free
end;
